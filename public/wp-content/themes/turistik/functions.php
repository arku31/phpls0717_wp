...
function akcii()
{
    ...
    $labels = array(
        'name' => _x('Akcii', 'Post Type General Name', 'text_domain'),
        'singular_name' => _x('Akcii', 'Post Type Singular Name', 'text_domain'),
    ...
    $args = array(
        'label' => __('Akcii', 'text_domain'),
        'description' => __('Akcii', 'text_domain'),
        'labels' => $labels,
        'supports' => array(),
...
add_action('init', 'akcii', 0);


// Register Custom Taxonomy
function otdel__taxonomy()
{
...
add_action('init', 'otdel__taxonomy', 0);